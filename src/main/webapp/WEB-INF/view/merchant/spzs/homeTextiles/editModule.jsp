...
function uploadImage4(){
	...
	$("#uploadFile4_div").append("<input type=\"text\" id=\"image"+uuid+"\" name=\"image"+uuid+"\" />");
...
function deleteImage4(o){
	...
	$("#uploadFile4_div input[type='text'][name='image"+uuid+"']").remove();
...
<div class="image4ModBg_div" id="image4ModBg_div">
	<div class="image4Mod_div" id="image4Mod_div">
		...
		<div id="tab_div">
			<table>
				<c:if test="${requestScope.htmlGoodsSPZS.image4_1 ne null||requestScope.htmlGoodsSPZS.image4_2 ne null||requestScope.htmlGoodsSPZS.image4_3 ne null||requestScope.htmlGoodsSPZS.image4_4 ne null }">
				<tr>
					<c:if test="${requestScope.htmlGoodsSPZS.image4_1 ne null }">
					<td class="file_td" id="file_td4_1">
						<img class="delete_img" alt="" src="/GoodsPublic/resource/images/004.png" onclick="deleteImage4(this);">
						<img class="item_img" id="img4_1" alt="" src="${requestScope.htmlGoodsSPZS.image4_1 }">
					</td>
					</c:if>
					<c:if test="${requestScope.htmlGoodsSPZS.image4_2 ne null }">
					<td class="file_td" id="file_td4_2">
						<img class="delete_img" alt="" src="/GoodsPublic/resource/images/004.png" onclick="deleteImage4(this);">
						<img class="item_img" id="img4_2" alt="" src="${requestScope.htmlGoodsSPZS.image4_2 }">
					</td>
					</c:if>
					<c:if test="${requestScope.htmlGoodsSPZS.image4_3 ne null }">
					<td class="file_td" id="file_td4_3">
						<img class="delete_img" alt="" src="/GoodsPublic/resource/images/004.png" onclick="deleteImage4(this);">
						<img class="item_img" id="img4_3" alt="" src="${requestScope.htmlGoodsSPZS.image4_3 }">
					</td>
					</c:if>
					<c:if test="${requestScope.htmlGoodsSPZS.image4_4 ne null }">
					<td class="file_td" id="file_td4_4">
						<img class="delete_img" alt="" src="/GoodsPublic/resource/images/004.png" onclick="deleteImage4(this);">
						<img class="item_img" id="img4_4" alt="" src="${requestScope.htmlGoodsSPZS.image4_4 }">
					</td>
					</c:if>
					<c:if test="${requestScope.htmlGoodsSPZS.image4_5 eq null }">
					<td id="upload_td">
				...
				<tr>
					<c:if test="${requestScope.htmlGoodsSPZS.image4_5 ne null }">
					<td class="file_td" id="file_td4_5">
						<img class="delete_img" alt="" src="/GoodsPublic/resource/images/004.png" onclick="deleteImage4(this);">
						<img class="item_img" id="img4_5" alt="" src="${requestScope.htmlGoodsSPZS.image4_5 }">
					</td>
					</c:if>
					<td id="upload_td">
						<img class="upload_img" alt="" src="/GoodsPublic/resource/images/005.png" onclick="uploadImage4();">
			...
			<div class="uploadFile4_div" id="uploadFile4_div">
				...
				<input type="text" id="image4_1" name="image4_1" value="${requestScope.htmlGoodsSPZS.image4_1 }" />
				</c:if>
				<c:if test="${requestScope.htmlGoodsSPZS.image4_2 ne null }">
				<input type="file" id="file4_2" name="file4_2" onchange="showQrcodePic4(this)" />
				<input type="text" id="image4_2" name="image4_2" value="${requestScope.htmlGoodsSPZS.image4_2 }" />
				</c:if>
				<c:if test="${requestScope.htmlGoodsSPZS.image4_3 ne null }">
				<input type="file" id="file4_3" name="file4_3" onchange="showQrcodePic4(this)" />
				<input type="text" id="image4_3" name="image4_3" value="${requestScope.htmlGoodsSPZS.image4_3 }" />
				</c:if>
				<c:if test="${requestScope.htmlGoodsSPZS.image4_4 ne null }">
				<input type="file" id="file4_4" name="file4_4" onchange="showQrcodePic4(this)" />
				<input type="text" id="image4_4" name="image4_4" value="${requestScope.htmlGoodsSPZS.image4_4 }" />
				</c:if>
				<c:if test="${requestScope.htmlGoodsSPZS.image4_5 ne null }">
				<input type="file" id="file4_5" name="file4_5" onchange="showQrcodePic4(this)" />
				<input type="text" id="image4_5" name="image4_5" value="${requestScope.htmlGoodsSPZS.image4_5 }" />
				</c:if>
			</div>
