...
<title>编辑</title>
<%@include file="../../js.jsp"%>
<link rel="stylesheet" href="<%=basePath %>/resource/css/spzs/homeTextiles/batchAddModule.css" />
...
function downloadExcelModule(){
	...
	jsonStr+="]";
	console.log(jsonStr);
	location.href=path+"merchant/excel/downloadExcelModule?trade=spzs&moduleType=homeTextiles&jsonStr="+jsonStr;
}
