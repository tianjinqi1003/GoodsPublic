...
<title>预览</title>
<%@include file="../../js.jsp"%>
<link rel="stylesheet" href="<%=basePath %>/resource/css/spzs/productExplain/browseHtmlGoods.css" />
	...
	<div class="left_div" id="left_div">
		...
		<div class="embed1_div" id="embed1_div">
			<c:if test="${requestScope.htmlGoodsSPZS.embed1_1 ne null }">
				<embed alt="" src="${requestScope.htmlGoodsSPZS.embed1_1 }" style="width: 95%;height: 300px;margin-top: 25px;">
			</c:if>
		</div>
	</div>
	<div class="right_div">
