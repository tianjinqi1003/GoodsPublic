...
$(function(){
	...
	tab1=$("#tab1").datagrid({
        ...
        onLoadSuccess:function(data){
			if(data.total==0){
				$(this).datagrid("appendRow",{productName:"<div style=\"text-align:center;\"><a href=\"${pageContext.request.contextPath}/merchant/main/goAddModule?trade=smyl\">点击生成树木园林模版</a><div>"});
